<template>
  <layout>
    ...
    <div class="mt-3" id="desktop">
          ...
          <div class="col-8">
            <div class="info-text text-center">
              <label style="margin-bottom: 0px"
                >IMPORTANT: Save as PDF or print before closing, resetting,
                reloading, or leaving this page.</label
              >
              <label
              ...
              <label class="mt-2"
                >IMPORTANT: See here for entering Investor's output data into
                Coinbase. The calculator does not make a sale or place an order
                on Coinbase.</label
              >
            </div>
          </div>
      ...
      <div class="row mb-5" style="display: flex; justify-content: center">
        ...
        <label class="info-text text-center col-12" style="font-size: 1.3rem"
          >Enter the six required values and scroll down, choose the valid
          Alternative values you want, and scroll down again.</label
        >
        <div class="col-sm-12 col-md-2 col-lg-2 mt-3 custom-box">
          <div class="form-group text-center">
            <div class="input-content">
              ...
              <div class="icon-image">
                <img
                  :src="cost_method_icon"
                  class="icons-img"
                  width="50"
                  height="50"
                />
              </div>
              <select id="cost_method_memo" v-model="cost_method_memo">
            ...
            <div class="input-content">
              ...
              <div class="input-group">
                ...
                <input
                  ...
                  @input="baseChanged()"
                  @change="
                    roundInputsTargets($event, 'basis_coins_on_hand'),
                      this.showError()
                  "
                  placeholder=""
                />
                ...
                <span
                  ...
                  v-if="!isSellingPriceTargetValid"
                  >{{ errors.basis_coins_on_hand }}</span
                >
              </div>
              <label class="required pt-2">Required</label>
            </div>
            ...
            <div class="input-content">
              ...
              <div class="input-group">
                ...
                <input
                  ...
                  @input="baseChanged()"
                  @change="
                    roundInputsTargets($event, 'coins_on_hand', 8),
                      this.showError()
                  "
                  placeholder=""
                />
            ...
            <div class="input-content">
              ...
              <div class="input-group">
                ...
                <input
                  ...
                  "
                  @change="
                    roundInputValue($event, 'percentage_coins_to_sell', 8)
                  "
                  placeholder=""
                />
              ...
              <div class="form-group text-center">
                <div class="input-content text-left">
                  <label style="font-size: 16px"
                    ...
                    Make TARGET Inputs, below, more than these values:, and/or
                    lower % or # of coins to sell</label
                  >
                </div>
              </div>
            </td>
          ...
          <tbody>
            ...
            <tr style="background-color: #4472c4; color: white">
              ...
              <td>
                ...
                <span
                  class="ml-2 table-warning"
                  v-if="!isSellingPriceTargetValid"
                  >{{ errors.selling_price_target }}</span
                >
              </td>
              <td>
                <div class="input-group">
                  ...
                  <input
                    ...
                    "
                    @change="
                      roundInputValue($event, 'net_profit_loss_target', 2)
                    "
                    placeholder=""
                  />
                </div>
                <span
                  class="ml-2 table-warning"
                  v-if="!isNetProfitLossTargetValid"
                  >{{ errors.net_profit_loss_target }}</span
                >
              </td>
              <td>
                <div class="input-group">
            ...
            <tr>
              ...
              <td class="col-2">
                {{
                  formatNumber(
                    net_profit_loss_percentage_result.net_profit_loss
                  )
                }}
                $
              </td>
            ...
            <tr>
              <th class="icon-cell"><i class="fas fa-coins"></i></th>
              <th class="col-2 table-heading">
                Enter in Coinbase. Coins to sell
              </th>
              <td
              ...
              <td v-else class="col-2">
                {{ selling_price_result.coin_sell }} Coins
              </td>
              ...
              <td v-else class="col-2">
                {{ net_profit_loss_result.coin_sell }} Coins
              </td>
              ...
              <td v-else class="col-2">
                {{ net_profit_loss_percentage_result.coin_sell }} Coins
              </td>
            </tr>
            <tr>
              <th class="col-2 table-heading">
              ...
              <td class="col-2">
                {{
                  formatNumber(
                    net_profit_loss_percentage_result.selling_price_per_coin
                  )
                }}
                $
              </td>
            ...
            <tr>
              ...
              <td
                v-if="
                  net_profit_loss_percentage_result.net_proceeds_bank < 0.01
                "
                class="table-warning col-2"
                data-toggle="tooltip"
                data-placement="top"
              ...
              >
                {{
                  formatNumber(
                    net_profit_loss_percentage_result.net_proceeds_bank
                  )
                }}
                $
              </td>
            ...
            <tr>
              ...
              <td class="col-2">
                {{ selling_price_result.coins_after_sale }} Coins
              </td>
              <td class="col-2">
                {{ net_profit_loss_result.coins_after_sale }} Coins
              </td>
              <td class="col-2">
                {{ net_profit_loss_percentage_result.coins_after_sale }} Coins
              </td>
            </tr>
      ...
      <div class="row px-3 my-3">
        <div
          class="col-12 text-center table-warning py-1"
          v-if="showPriceError"
        >
          <h4 class="mt-2">
            Make selling price for one full coin greater than Recent Coinbase
            market price
          </h4>
        </div>
      </div>
        ...
        <tbody>
          ...
          <tr style="color: white !important">
            ...
            <td style="background-color: #4472c4">
              ...
              <span
                class="ml-2 table-warning"
                v-if="!isNetProceedsBankTargetValid"
                >{{ errors.net_proceeds_bank_target }}</span
              >
            </td>
            <td style="background-color: #4472c4">
              <div class="input-group">
          ...
          <tr v-if="targetInputsFilled">
            ...
            >
              ...
              ><span class="float-right">{{
                formatNumber(
                  net_proceeds_percentage_result.selling_price_per_coin
                )
              }}</span>
            </td>
          </tr>
          ...
          <tr v-if="targetInputsFilled">
            ...
            <td class="col-2">
              ...
              ><span class="float-right"
                >{{
                  formatNumber(
                    net_profit_loss_percentage_result.variable_selling_fee
                  )
                }}
              </span>
            </td>
            ...
            <td class="col-2">
              ...
              ><span class="float-right"
                >{{
                  formatNumber(
                    net_proceeds_percentage_result.variable_selling_fee
                  )
                }}
              </span>
            </td>
          ...
          <tr v-if="targetInputsFilled">
            ...
            <td class="col-2 text-right">
              ...
              ><span class="float-right">{{
                formatNumber(
                  net_proceeds_percentage_result.coins_after_sale,
                  8,
                  8
                )
              }}</span>
      ...
      <div
        ...
        v-if="upperInputsFilled && targetInputsFilled"
      >
        <div class="px-2">
          <button
            class="btn"
        ...
        <div class="px-2">
          <button
            class="custom-button-export btn text-light"
            @click="resetInputs()"
          >
            Reset
          </button>
    ...
    <div id="mobile" style="font-size: 12px !important">
      <div class="text-center">
        <div class="info-text text-left">
          ...
          <label class="mt-2"
            >IMPORTANT: See here for entering Investor's output data into
            Coinbase. The calculator does not make a sale or place an order on
            Coinbase.</label
          >
        ...
        <div class="row mobile-input-row">
          ...
          <div class="col-3 px-0 text-left">
            <label class="mt-1 px-2 input-label-text"
              >Required (need help?)</label
            >
          </div>
        </div>
        <!-- input group end -->
        ...
        <div class="row mobile-input-row">
          ...
          <div class="col-6 px-0">
            <div class="input-group input-group-sm">
              <div class="input-group-prepend">
                <span class="input-group-text custom-input-mobile-dollar"
                  >$</span
                >
              </div>
        ...
        <div class="row mobile-input-row">
          ...
          <div class="col-6 px-0">
            <div class="input-group input-group-sm w-70">
              <div
                class="input-group-prepend custom-input-mobile border-right-0 p-0"
              >
                <button
                  class="btn btn-outline-secondary dropdown-toggle py-0 px-1 shadow-0 border-0"
                  type="button"
          ...
          <div class="row px-3 my-3">
            ...
            >
              <h4 class="mt-2 input-label-text">
                Make selling price for one full coin greater than Recent
          ...
          >
            <tbody>
              ...
              <tr class="text-left">
                ...
                <th>
                  Alternative 3 <br />Net profit (loss) TARGET % [ratio to this
                  sell's cost]
                </th>
              </tr>
    ...
    <div class="col-12 col-sm-12 col-md-4 col-lg-12">
      ...
      >
        <section
          data-testid="alert-banner-text-wrap"
          class="alert-banner__text-wrap"
        >
          <section
            data-testid="alert-banner-text-rte"
          ...
          >
            ...
            <p>
              Disclaimer: Information provided is for general educational
              purposes only and is not intended to constitute investment or
              other advice on financial products. Such information is not, and
              should not be read as, an offer or recommendation to buy or sell
              or a solicitation of an offer or recommendation to buy or sell any
              particular digital asset or to use any particular investment
              strategy. Crypto Wiz Guy® and its affiliates (collectively “Crypto
              Wiz Guy®”) makes no representations as to the accuracy,
              completeness, timeliness, suitability, or validity of any
              ...
              arising from its display or use. Investing in crypto comes with
              risk. Please carefully consider whether trading or holding
...
export default {
  ...
  methods: {
    ...
    showError() {
      ...
      if (
        (selling_price_price >= selected_coin_price ||
          isNaN(selling_price_price)) &&
        ...
        (net_profit_loss_price >= selected_coin_price ||
          isNaN(net_profit_loss_price)) &&
    ...
    async exportFile(is_mobile = false) {
      ...
      const params = {
        ...
        guidance_net_profit_loss_percentage:
          this.guidance_net_profit_loss_percentage,
    ...
    calculateSellingPriceResult() {
      ...
      let selling_price_per_coin =
        this.selling_price_target_value == 0
          ? 0
          : this.selling_price_target_value; //Selling price per full coin
      ...
      let net_profit_loss =
        net_proceeds_bank -
        this.basis_coins_on_hand_value * percentage_coins_to_sell; //Net profit (loss) $
      ...
      let coins_after_sale =
        this.coins_on_hand_value * (1 - percentage_coins_to_sell); //Coins after sale
      ...
      this.selling_price_result = {
        ...
        net_profit_loss_percentage_ratio: parseFloat(
    ...
    calculatNetProceedsBankResult() {
      ...
      let net_proceeds_bank_target = parseFloat(
        this.net_proceeds_bank_target_value
      ); //Net proceeds $ to bank or reinvest

      let fee_rate = parseFloat(this.fee_rate) / 100; //Fee rate

      let variable_selling_fee =
        (net_proceeds_bank_target * fee_rate) / (1 - fee_rate); //Variable selling fee
    ...
    calculatNetProceedsPercentageResult() {
      ...
      let variable_selling_fee =
        (net_proceeds_bank * fee_rate) / (1 - fee_rate); //Variable selling fee
      let selling_price_per_coin =
        this.coins_on_hand_value == 0 || this.percentage_coins_to_sell == 0
          ? 0
    ...
    checkValidation() {
      ...
      this.basis_coins_on_hand_value == "" ||
      this.basis_coins_on_hand_value == null
    ...
    calculateGuidanceResult() {
      ...
      this.guidance_selling_price_full_coin = this.formatNumber(
        selling_price_per_coin
      );
  ...
  computed: {
    ...
    targetInputsFilled() {
      return (
        (this.selling_price_target != null &&
          this.selling_price_target != "") ||
        (this.net_profit_loss_target != null &&
          this.net_profit_loss_target != "") ||
        (this.net_profit_loss_percentage_ratio_target != null &&
          this.net_profit_loss_percentage_ratio_target != "") ||
        (this.net_proceeds_bank_target != null &&
          this.net_proceeds_bank_target != "") ||
        (this.net_proceeds_percentage_ratio_target != null &&
          this.net_proceeds_percentage_ratio_target != "")
      );
